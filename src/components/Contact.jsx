const socialLinks = [
    {
        href: 'https://github.com/lethanhphat1005',
    ...
    {
        href: 'https://www.linkedin.com/in/ph%C3%A1t-l%C3%AA-th%C3%A0nh-12b827354/',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="mb-12 lg:mb-0 lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        I’m currently a student looking for internship opportunities.
                ...
                <form
                    action="https://getform.io/f/axozrrvb"
                    method="POST"
